...
# ลบ delisted stocks ออก: NKLA, GOEV, SAVA, BBBY, RIDE, WKHS
WATCHLIST = [
    'GME','AMC','SPCE','SNDL',
    'BYND','MARA','RIOT','CLSK',
    'NVAX','SRPT',
...
# ============================================================
# INDICATORS — คำนวณเอง ไม่ใช้ pandas_ta
# ============================================================
...
def check_technical(d):
    try:
        ...
        bb_upper, _, bb_lower = calc_bbands(close)
...
# ============================================================
# STATS SUMMARY — แก้ unpack tuple ให้ตรงกับ results format
# ============================================================
def build_summary(all_data, results):
    ...
    # แก้: unpack 5 ค่า (score, d, sq, tech, plan)
    alerts = sum(1 for score, d, sq, tech, plan in results if sq.get('alert'))
...
def main():
    ...
    for ticker in WATCHLIST:
        ...
        results.append((score, d, sq, tech, plan))   # 5 ค่า
